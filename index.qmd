...
The goal of this project was to become famiar with all the tools we'll be using this semester in Laboratory Instrumentation and to make some real measurements, and analyze some real data. I learned alot about resistors and capacitors.I also learned how to run code and create reports in Github. 
